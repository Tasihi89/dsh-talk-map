window.__ModuleLoader__.load({ id: "dsh-talk-map", factory: (require) => {
		...
		*/
		...
		function frameRects(cards, wsOfCard, wsList) {
		...
		function CanvasInner(props) {
			...
			const frames = (0, react.useMemo)(() => frameRects(visibleCards, wsOfCard, wsList), [
				visibleCards,
				wsOfCard,
				wsList
			]);
